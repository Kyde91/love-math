// wait for dom to finish loding before unning a game
...
function runGame(gameType) {
  ...
  //creates two numbers between 1-25
 ...
 * the retutrned calculateCorrectAnswer array
 */
...
/**
 * Gets the operand (the numbers) and the operator (plus, minus, divide etc)
...
function displayDivisionQuestion(operand1, operand2) {
  document.getElementById("operand1").textContent = Math.floor(
    operand1 * operand2
  );
  document.getElementById("operand2").textContent = operand2;
  document.getElementById("operator").textContent = "/";
